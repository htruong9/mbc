...
export function main() {
    try {
        ...
        const productSelectElements = document.querySelectorAll(
            ".product-options select"
        );
        // const productCheckboxInputElements = document.querySelectorAll(".product-options input[type='checkbox']");

        const additionalPositionElement = document.querySelector(
            ".additional-position"
        );
        const sizeSelectElement = document.querySelector(
            ".size-option select#size_select"
        );
        const additionalPositionSelectElement =
            additionalPositionElement.querySelector(
                "#additional-position__select"
            );
        const logoTextSelectElements =
            document.querySelectorAll(".logo-text__select");
        const additionalNameSelectElement = document.querySelector(
            "#additional-name__select"
        );

        const logoFileUploadElements = document.querySelectorAll(
        ...
        const mainPositionSelectElement = document.querySelector(
            ".position-options select#position"
        );
        const positionCheckboxElements =
            document.querySelectorAll(".position-checkbox");
        const additionalNamePositionCheckboxElements =
            document.querySelectorAll(".additional-name-position-checkbox");
        const dataCheckedPositionElement = document.querySelector(
            "#data-checked-position"
        );
        ...
        const vouchersSumElement =
            orderSumElement.querySelector("#sum_vouchers");
        ...
        const requireTextOptionInputElement = document.getElementById(
            "require_text_option__input"
        );
        const additionalTextOptionInputElement =
            document.getElementById("text_option__input");
        ...
        const getEachItemPrice = () => {
            return new Promise((resolve, reject) => {
                try {
                    ...
                    Object.entries(
                        UserSelected.Additional_name.positions
                    ).forEach((e) => {
                        var str = e[1].additionalPrice;
                        result += parseFloat(str);
                    });
            ...
            return new Promise((resolve, reject) => {
                getEachItemPrice()
                    .then((value) => {
                        try {
                            var result = 0;
                            UserSelected.Quantity = parseInt(
        ...
        const getEachItemPriceAfterDiscount = () => {
            return new Promise((resolve, reject) => {
                try {
                    var result = UserSelected.Variant.price;
        ...
        const getAllItemPriceAfterDiscount = () => {
            return new Promise((resolve, reject) => {
                getEachItemPriceAfterDiscount()
                    .then((value) => {
                        try {
                            ...
                            // }
                            UserSelected.All_items_price_after_discount =
                                result;
                            resolve(result);
                        } catch (error) {
                            reject(error);
        ...
        const sumVariantPriceElement =
            orderSumElement.querySelector("#sum_variant-price");
        ...
        const sumPositionElement =
            orderSumElement.querySelector("#sum_position");
        const sumAdditionalPositionElement = orderSumElement.querySelector(
            "#sum_additional-position"
        );
        const sumAdditionalLogoTextElement = orderSumElement.querySelector(
            "#sum_additional-logo-text"
        );
        const sumAdditionalNameElement = orderSumElement.querySelector(
            "#sum_additional-name"
        );
        const sumRequireLogoTextElement = orderSumElement.querySelector(
            "#sum_require-logo-text"
        );
        const sumDeliveryFeeElement =
            orderSumElement.querySelector("#sum_delivery-fee");
        const sumVoucherElement =
            orderSumElement.querySelector("#sum_vouchers");
        ...
        (() => {
            ...
            e = mainPositionSelectElement.querySelector(
                `option[value="${mainPositionSelectElement.value}"]`
            );
            ...
            const allSameCheckboxValue = document.querySelectorAll(
                `.position-checkbox[name='${mainPositionSelectElement.value}']`
            );
            ...
            e = sizeSelectElement.querySelector(
                `option[value="${sizeSelectElement.value}"]`
            );
            UserSelected.Size = {
                title: e.textContent,
                id: e.value,
            ...
            e = document.querySelector(
                ".require-logo-text-options .logo-text__select"
            );
            if (e) {
                UserSelected.Require_logo_text.is_require = isRequire;
                UserSelected.Require_logo_text.selected =
                    e.querySelector(`option[value="${e.value}"]`).value === "1"
                        ? "logo"
                        : "text";
                UserSelected.Require_logo_text.price = e.querySelector(
        ...
        function update() {
            if (!isUpdating) {
                ...
                try {
                    ...
                    // Variant price
                    sumVariantPriceElement.querySelector(".value").textContent =
                        toMoneyString(UserSelected.Variant.price, true);

                    // Colour
                    sumColourElement.querySelector(".value").textContent =
                        UserSelected.Colour.title;

                    // Size
                    sumSizeElement.querySelector(".value").textContent =
                        UserSelected.Size.title;

                    // Position
                    positions = getPositionByType("main");
                    additionalPrice = addtionalPriceToText(
                        UserSelected.Position[positions[0]].additionalPrice
                    );
                    sumPositionElement.querySelector(".value").textContent =
                        UserSelected.Position[positions[0]].title +
                        additionalPrice;

                    // Additional position
                    if (UserSelected.Additional_position.selected) {
                        sumAdditionalPositionElement.querySelector(
                            ".value"
                        ).innerHTML = "";
                        const positions = getPositionByType(
                            "Additional position"
                        );
                        positions.forEach((e, i) => {
                            ...
                            element.textContent =
                                UserSelected.Position[e].title +
                                addtionalPriceToText(
                                    UserSelected.Position[e].additionalPrice
                                );
                            sumAdditionalPositionElement
                                .querySelector(".value")
                                .appendChild(element);
                        });
                    ...
                    // Require logo/text
                    if (
                        UserSelected.Require_logo_text.is_require &&
                        UserSelected.Require_logo_text.selected
                    ) {
                        ...
                        sumRequireLogoTextElement.appendChild(
                            createPairContainerElement(
                        ...
                        const positions =
                            getPositionByType("Require_logo_text");
                        positions.forEach((e, i) => {
                            sumRequireLogoTextElement.appendChild(
                                createPairContainerElement(
                                    "Position",
                    ...
                    if (UserSelected.Additional_logo_text.selected) {
                        ...
                        const selectedType =
                            UserSelected.Additional_logo_text.selected;
                        if (selectedType == "logo") {
                            value = false;
                        ...
                        sumAdditionalLogoTextElement.appendChild(
                            createPairContainerElement(
                                `Additional ${selectedType}`,
                                value,
                                img
                            )
                        );
                    ...
                    if (UserSelected.Additional_name.selected) {
                        ...
                        sumAdditionalNameElement.appendChild(
                            createPairContainerElement(
                                `Additional name`,
                                "Free"
                            )
                    ...
                    // Delivery fee
                    sumDeliveryFeeElement.querySelector(".value").textContent =
                        UserSelected.Delivery_Fee === "free"
                            ? "Free"
                            : CurrencySymbol + UserSelected.Delivery_Fee;
                    ...
                    getTotalPrice()
                        .then((value) => {
                            priceSumElement.querySelector(
                                ".value"
                            ).textContent =
                                CurrencySymbol + value.toFixed(2).toString();
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    if (data.length > 0) {
                                        ...
                                        getTotalPriceAfterDiscount().then(
                                            (value) => {
                                                priceSumElement.querySelector(
                                                    ".value"
                                                ).textContent = `${CurrencySymbol}${totalPrice
                                                    .toFixed(2)
                                                    .toString()} -> ${CurrencySymbol}${value
                                                    .toFixed(2)
                                                    .toString()}`;
                                                ...
                                                if (
                                                    ...
                                                    sumRequireLogoTextElement.style.display =
                                                        "block";
                                                } else {
                                                    sumAdditionalLogoTextElement.style.display =
                                                        "none";
                                                }

                                                // Delivery fee
                                                sumDeliveryFeeElement.querySelector(
                                                    ".value"
                                                ).textContent =
                                                    CurrencySymbol +
                                                    (UserSelected.Delivery_Fee -
                                                        UserSelected.Discount
                                                            .Delivery_Fee);
                                            }
                                        );
                                    }
        ...
        function addVoucher(voucher) {
            ...
            var currentPrice =
                forField === FOR_REQUIRE_LOGO_TEXT
                    ? UserSelected.Require_logo_text.price
                    : forField === FOR_ADDITIONAL_LOGO_TEXT
                    ? UserSelected.Additional_logo_text.price
                    : forField === FOR_DELIVERY_FEE
                    ? UserSelected.Delivery_Fee
                    : forField === FOR_EACH_ITEM
                    ? UserSelected.Each_item_price
                    : forField === FOR_ALL_ITEM
                    ? UserSelected.All_items_price
                    : 0;
            var discountValue = 0;
            console.log(
                `Price before for ${forField} - ${voucher.name}: ${currentPrice}`
            );
            ...
            sumVoucherElement.appendChild(
                createPairContainerElement("Applied", voucher.name)
            );
        }
        ...
        function onSizeSelection(event) {
            ...
            UserSelected.Size.title = event.target.querySelector(
                `option[value="${event.target.value}"]`
            ).textContent;
            update();
        }

        additionalPositionSelectElement.onchange = (e) =>
            onAdditionalOptionsSelection(e, "position");
        ...
        additionalNameSelectElement.onchange = function (event) {
            ...
            const formGroup = target
                .closest(".product-option")
                .querySelector(".form-group-wrapper");
            if (choice) {
                setDisplay = "block";
                // checkboxGroup.style.display = 'block'
        ...
        logoTextSelectElements.forEach((e) => {
            e.onchange = function (event) {
                ...
                const selectedOptionElement = target.querySelector(
                    `option[value="${value}"]`
                );
                const positionOptionElement =
                    root.querySelector(".position-option");
                const logoOptionElement = root.querySelector(
                    ".options-container .logo-option"
                );
                const textOptionElement = root.querySelector(
        ...
        logoFileUploadElements.forEach((e) => {
            e.onchange = function (event) {
                ...
                const root = target.closest(".product-option");
                const logoFilePreviewElement = root.querySelector(
                    ".file-upload__preview"
                );
                const logoFileUploadLabelElement =
                    root.querySelector(".custom-file-label");
                const type = root.dataset.type;
        ...
        mainPositionSelectElement.onchange = function (event) {
            ...
            UserSelected.Position = Object.fromEntries(
                Object.entries(UserSelected.Position).filter((e) => {
                    return e[1].type !== "main";
                })
            );
            UserSelected.Position[target.value] = {
                type: "main",
                title: target.querySelector(`option[value="${target.value}"]`)
                    .dataset.title,
                additionalPrice: target.querySelector(
                    `option[value="${target.value}"]`
                ).dataset.price,
            };

            const allCheckBox = document.querySelectorAll(
                `.position-checkbox[name]`
            );
            const allSameCheckboxValue = document.querySelectorAll(
                `.position-checkbox[name='${target.value}']`
            );
        ...
        positionCheckboxElements.forEach((e) => {
            e.onchange = function (event) {
                const target = event.target;
                const allSameCheckboxValue = document.querySelectorAll(
                    `.position-checkbox[name='${target.name}']`
                );
                const checkedElements = [...allSameCheckboxValue].filter(
                    (e) => {
                        return e !== target && e.checked;
                    }
                );
                ...
                if (checkedElements.length === 0) {
                    if (target.checked) {
                        dataCheckedPositionElement.dataset[
        ...
        addToCartButton.onclick = function (e) {
            if (UserSelected.Additional_name.selected) {
                UserSelected.Additional_name.name = document.getElementById(
                    "input__additional-name"
                ).value;
            }
            if (
                UserSelected.Require_logo_text.is_require &&
                UserSelected.Require_logo_text.selected === "text"
            ) {
                UserSelected.Require_logo_text.text =
                    requireTextOptionInputElement.value;
                UserSelected.Require_logo_text.font =
                    requireTextOptionInputElement.parentNode.querySelector(
                        ".font-input"
                    ).value;
                UserSelected.Require_logo_text.color =
                    requireTextOptionInputElement.parentNode.querySelector(
                        ".color-input"
                    ).value;
            }
            if (UserSelected.Additional_logo_text.selected === "text") {
                UserSelected.Additional_logo_text.text =
                    additionalTextOptionInputElement.value; // change to additional_text_option__input
                UserSelected.Additional_logo_text.font =
                    additionalTextOptionInputElement.parentNode.querySelector(
                        ".font-input"
                    ).value;
                UserSelected.Additional_logo_text.color =
                    additionalTextOptionInputElement.parentNode.querySelector(
                        ".color-input"
                    ).value;
            }
            UserSelected.Quantity = document.querySelector(
                `input[name="quantity"]`
            ).value;
        ...
        function getPositionByType(type) {
            return Object.keys(UserSelected.Position).filter(
                (key) => UserSelected.Position[key].type === type
            );
        }
        ...
        function clickLeftThumb() {
            var imgSrc = document
                .querySelector(
                    `.color-option input[value="${UserSelected.Variant.id}"] ~ a img`
                )
                .getAttribute("src");
            document
                .querySelector(
                    `.product__thumb.nice-scroll .pt img[src="${imgSrc}"]`
                )
                .click();
        }
        ...
        // Logo suggest
        const showUploadedLogoButtonElements = document.querySelectorAll(
            ".btn_show-uploaded-logo"
        );
        const uploadedLogoSelectElements = document.querySelectorAll(
            ".uploaded-logo-select"
        );
        ...
        uploadedLogoSelectElements.forEach((e) => {
            e.onclick = function (event) {
                ...
                document
                    .querySelectorAll(".uploaded-logo-select.checked")
                    .forEach((e) => {
        ...
        [
            requireTextOptionInputElement,
            additionalTextOptionInputElement,
        ].forEach((e) => {
            e.onfocusout = function () {
                ...
                document.querySelector(
                    `#sum_${type.replaceAll("_", "-").toLowerCase()} .value`
                ).textContent = `  ${e.value}  `;
            };
        });
        ...
        colorInputElements.forEach((e) => {
            e.onchange = function () {
                ...
                textInputElement.style.backgroundColor = contrastingColor(
                    e.value
                );
